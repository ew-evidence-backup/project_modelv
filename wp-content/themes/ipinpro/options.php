...
function optionsframework_options() {
	...
	*/
	...
	$options[] = array(
		...
		<ol>
		<li><a href="wordpress.org/extend/plugins/wp-super-cache/" target="_blank">WP Super Cache</a></li>
		<ul>
		<li>- Advanced Tab: "Don\'t cache pages for known users" must be ticked</li>
		</ul>
		<li><a href="http://wordpress.org/extend/plugins/wordpress-social-login/" target="_blank">WordPress Social Login</a> (allow users to login with Facebook or Twitter)</li>
		<ul>
